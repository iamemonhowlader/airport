! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.replaceWith('<span class="elementskit-submenu-indicator ekit-spinner"></span>'), e(document).width() <= Number(o) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(n) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(n), t.find(".elementskit-submenu-indicator.ekit-spinner").replaceWith(s), t.find(".elementor-element").each((function() {
    ...
    let n = {
        ...
        Nav_Menu: function(t) {
            if (t.find(".elementskit-megamenu-has").length > 0) {
                ...
                e(window).on("resize", (function() {
                    ...
                    }), t && t !== undefined ? "string" == typeof t ? (/^[0-9]/.test(t), s(i, t, n)) : i.css({
                        width: t + "px"
                    }) : s(i, t, n)
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(n) {
                    ...
                    t.find(".elementskit-dropdown-has").not(o).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"), s.toggleClass("ekit-dropdown-open-onclick")
                })), e(window).on("resize", (function() {
            ...
            if (n.length) {
                switch (n[0].classList[0]) {
                    ...
                    case "elementskit-countdown-timer-3":
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + a + '"><div class="' + s + '"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + a + '"><div class="' + s + '"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + a + '"><div class="' + s + '"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + a + '"><div class="' + s + '"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>"
                }
            ...
            ElementsKit_Helper ? .observeElement(n[0], (e => {
                n.easyPieChart({
                    barColor: !0 === s.gradientChart ? function(e) {
                        ...
                        return i.addColorStop(0, s.gradientColor1), i.addColorStop(1, s.gradientColor2), i
                    } : s.barColor,
        ...
        PostTab: function(t) {
            var n = t.hasClass("is-click-yes") ? "click" : "mouseover",
                ...
                o = t.find(".tabItem");
            i.on(n, (function() {
                i.removeClass("active"), o.removeClass("active"), e(this).addClass("active"), o.eq(e(this).index()).addClass("active")
            }))
        },
        ...
        Team: function(t) {
            ...
            }), i.off("click.ekitTeamModal").on("click.ekitTeamModal", ".ekit-team-modal-close", (function() {
        ...
        Video: function(t) {
            ...
            if (n.length > 0) {
                const l = {
                    ...
                    callbacks: {
                        ...
                        open: function() {
                            o.find(".mfp-close").addClass("ekit-popup-close"), window.dispatchEvent(new Event("resize"))
                        },
                        close: function() {
                            o.find(".mfp-close").removeClass("ekit-popup-close"), t.find("video").each((function() {
                                this.pause()
                            }))
                        }
                    }
                };
                "iframe" === s.videoType && (l.iframe = {
            ...
            s = (a = t.find(".ekit-video-frame")).data("video-setting");
            ...
            l.find(".ekit-inline-video-overlay-image").length > 0 && r.length > 0 && r.on("click", (function(n) {
                ...
                } else if (("youtube" === s.videoTypeName || "vimeo" === s.videoTypeName) && "inline" === s.videoStyle && s.autoplay) {
